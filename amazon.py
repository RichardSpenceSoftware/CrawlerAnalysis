# -*- coding: utf-8 -*-
"""
Created on Mon Jan 10 10:59:53 2022
...
pointer.execute("SELECT * FROM Amazon")
amazonframe = pointer.fetchall()
amazonframe = DataFrame(amazonframe,columns =['Review Id','Review','Star','Date','Location','Company'])
amazonframe["Star"] = pd.to_numeric(amazonframe["Star"])
...
data_score = amazonframe.groupby("Location", as_index=False)\
    .agg(('count', 'mean'))\
    .reset_index()
